...
const CONFIG_LEVELS = [
  // Nível 1: Introdução - Movimento básico
  {
    id: 1,
    name: "Introdução",
    start: { x: 0, y: 0 },
  ...
  // Nível 18: Caos
  {
    ...
    trophy: { x: 9, y: 9 },
    walls: [
      { x: 0, y: 2 }, { x: 2, y: 0 }, { x: 2, y: 3 },
      { x: 4, y: 0 }, { x: 4, y: 4 }, { x: 6, y: 2 },
      { x: 6, y: 5 }, { x: 8, y: 3 }
    ],
    traps: [
      { x: 1, y: 1 }, { x: 2, y: 1 }, { x: 3, y: 2 },
      { x: 5, y: 1 }, { x: 5, y: 3 }, { x: 5, y: 5 },
      { x: 7, y: 1 }, { x: 7, y: 4 }, { x: 7, y: 5 }
    ],
    maxBlocks: 42
  },
